...
require([
  ...
  esriConfig.apiKey =
    "AAPK0ab1ad9de14c4ec2827bc685240befc2oqSFsxEpdS40T8c6J3R2ES1fu2HdkNKAbQogfMbd6O1DaqWhQjmD_DsO0PZOnMaM";
  var map = new Map({
    basemap: "satellite",
  ...
  function difficultyButtonMaster(difficulty) {
    ...
    difficultyBtn.addEventListener("click", () => {
      ...
      for (d of diff) {
        ...
        if (map.findLayerById(d + "RouteLayer"))
          map.findLayerById(d + "RouteLayer").visible = false;
        // hide the leg card of different difficulty
        // console.log(d + 'LegCardContainer set display none')
        // console.log(d + 'LegCardContainer')
        document.getElementById(d + "LegCardContainer").style =
          "display: none;";
        document.getElementById(d + "-btn").style.backgroundColor = "white";
        document.getElementById(d + "-btn").style.color = "black";
      }
      // For turining on required difficulty routes
      difficultyBtn.style.backgroundColor = "#343840";
      difficultyBtn.style.color = "#fff";
      ...
      document.getElementById(difficulty + "LegCardContainer").style =
        "display: block;";
      document.getElementById(
        difficulty + "beginner-btn"
      ).style.backgroundColor = "#343840";
      document.getElementById(difficulty + "-btn").style.backgroundColor =
        "#343840";
      document.getElementById(difficulty + "-btn").style.fontSize = "20px";
      // document.getElementById('
    });
  }
        ...
        for (let i in data) {
          if (data[i]) {
            ...
            if (!standList.includes(startLocation)) {
              stand(
                startLocation,
                [data[i].coords[0][0], data[i].coords[0][1]],
                groupLayerName
              );
  ...
  function addViewPoint(location, name, image_url) {
    ...
    var popupTemplate = new PopupTemplate({
      title: "{name}",
      content:
        '<a href="{image}" target="_blank"><img src="{image}" width="400" height="250"></a>',
    });
  ...
  addViewPoint(
    [85.56115600377703, 28.218051006003503],
    "GLA Lake",
    "https://raw.githubusercontent.com/Laliguras/lali-s3-temp/main/viewPoint/GLA_Lake_viewpoint.jpeg"
  );
  addViewPoint(
    [85.57093487320884, 28.21773512253451],
    "Kyanjin Ri Lower Peak",
    "https://raw.githubusercontent.com/Laliguras/lali-s3-temp/main/viewPoint/Kyanjin_Ri_viewpoint.jpeg"
  );
